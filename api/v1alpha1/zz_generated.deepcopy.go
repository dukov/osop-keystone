...
func (in *KeystoneServerSpec) DeepCopyInto(out *KeystoneServerSpec) {
	*out = *in
	if in.Config != nil {
		...
		*out = make(map[string]KyestoneConfig, len(*in))
		for key, val := range *in {
			...
			if val == nil {
				...
				in, out := &val, &outVal
				*out = make(KyestoneConfig, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KyestoneConfig) DeepCopyInto(out *KyestoneConfig) {
	{
		in := &in
		*out = make(KyestoneConfig, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyestoneConfig.
func (in KyestoneConfig) DeepCopy() KyestoneConfig {
	if in == nil {
		return nil
	}
	out := new(KyestoneConfig)
	in.DeepCopyInto(out)
	return *out
}
